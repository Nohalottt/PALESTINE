<div class="fotter" style="background-color:green;">
	 <div class="container" >
		 <div class="fotter-grids" >
			 <div class="col-md-4 fotter-left"  style="color: green;"> 
				
			
			
			 <p style="text-align:justify" style="color: green;"> <img src="images/m.jpg" alt="" style="height:400px; width:800px"> </p> <br><br>
			 </div>
			 <div >
...
<div class="copyright text-right" style="background-color:red;">
<p style="padding-right:100px ; color:#000000">SAVEPALESTINE</p>
</div>
